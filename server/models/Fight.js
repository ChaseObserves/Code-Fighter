...
mongoose.model("fights", fightSchema); // One argument means we're trying to fetch something out of mongoose, two arguments (i.e. 'users', userSchema) means we're trying to load something into it.
